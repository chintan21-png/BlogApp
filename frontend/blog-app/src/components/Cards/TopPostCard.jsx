  ...
  return (
    <div className='bg-white py-4 flex flex-col gap-3 border-b border-gray-100'>
        <div className='flex items-start gap-2'>
            <img src={coverImageUrl} alt={title} className='w-10 h-10 rounded-md object-cover'></img>
        ...
        <div className='flex items-center justify-between text-xs text-gray-600'>
            ...
            <span className='flex items-center gap-1 text-sm text-black'><LuHeart className='text-[16px] text-gray-500'/>{likes} likes</span>
        </div>
    </div>
  )
}
